...
import { LogOut, UploadCloud, LayoutDashboard, ShieldCheck } from 'lucide-react';
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <button
              ...
              title="Đăng xuất"
              className="flex items-center space-x-1 px-3 py-2 text-sm font-medium text-red-400 hover:bg-red-950/40 hover:text-red-300 rounded-md transition ml-2 border border-red-900/50"
            >
